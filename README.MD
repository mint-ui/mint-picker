...
| showToolbar | Boolean(default: true) show a toolbar on top of picker when showToolbar is true. |
...
| values | Array values of all slots except divider slots. This is not a prop, just a readonly property. |
